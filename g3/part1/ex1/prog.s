...
main:   move $s0,$ra
        ...
        ori $t3, $t3, 0x0001 # MODIFY (bit0=1 (1 means INPUT))
...
while:  li $v0,1                    
        ...
        andi $t5,$t4,0X0001 # Verificar valor de RB0
        lw $t6,LATE($t1) # (Mem_addr = 0xBF880000 + 0x6120)
        andi $t6,$t6, 0xFFFE # MODIFY (RE0=0)
        or   $t6,$t5 # Atribuir o valor de RB0 a RE0
