...
while:      li  $a0,666
            ...
            andi $t6,$t7,0X2 # Verificar valor de RB2
            beq  $t6,0X2, n_j # Se RB2 = 1 

            # Regressive Ring Counter
r_j:        andi $t5,$t0,0x000F

r_zero4:    bne $t5,0x0,r_skip
            li $t0,0xFFFFFE10
...
r_skip:     andi $t4,$t4, 0xFFF0 # 4 Bits = 0
            ...
            ror  $t0,$t0,1
            j while
            # End of Regressive Ring Counter

            # Normal Ring Counter
n_j:        andi $t5,$t0,0X000F

n_zero4:    bne $t5,0x0,n_skip
            li $t0,0x80
            sll $t0,$t0,24
